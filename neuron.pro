...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.neuron
    BOOST_LIB_SUFFIX=-mt
...
SOURCES += \
    ...
    src/qt/neurongui.cpp \
    src/qt/neuron.cpp \
    src/qt/neuronbridge.cpp
...
# also add new translations to neuron.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/neuron*.ts)
...
macx:ICON = src/qt/res/icons/neuron.icns
macx:TARGET = "Neuron"
