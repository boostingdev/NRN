...
/**
  Neuron GUI main class. This class represents the main window of the Neuron UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NeuronGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit NeuronGUI(QWidget *parent = 0);
    ~NeuronGUI();
