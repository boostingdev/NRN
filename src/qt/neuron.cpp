// Copyright (c) 2014 The Neuron developers
...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", NeuronGUI::tr("A fatal error occurred. Neuron can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    app.setOrganizationName("The Neuron Project");
    app.setOrganizationDomain("neuron.cash");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("Neuron-testnet");
    else
